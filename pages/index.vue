      ...
      <div class="sambutan">
        ...
        <div class="sambutan-content">
          ...
          <marquee direction="up" scrollamount="2" class="marquee-text">
            ...
            memberikan rahmat dan anugerahnya sehingga WEBSITE SMKN 4
            TASIKMALAYA ini dapat terbit. salah satu tujuan dari website ini
            adalah untuk menjawab akan setiap kebutuhan informasi dengan
            memanfaatkan sarana teknologi informasi yang ada.
          </marquee>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <h4
            ...
            class="text-white text-center rounded-3 p-2 m-3"
          >
        ...
        <div class="row d-flex justify-content-center">
          ...
          <div class="col-lg-4 col-md-5 mb-4">
            <div class="card shadow-sm text-center" style="width: 100%">
              <div class="icon-container mx-auto mt-3">
                <img
                  src="/assets/dkv.jpg.jpg"
                  class="card-icon"
                  alt="Icon Kompetensi 1"
                  width="25%"
                />
              </div>
              <div class="card-body">
                <h5 class="card-title text-center">DKV</h5>
                <p class="card-text">Desain komunikasi visual</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card shadow-sm text-center" style="width: 100%">
              <div class="icon-container mx-auto mt-3">
                <img
                  src="/assets/pplg.jpg.jpg"
                  class="card-icon"
                  alt="Icon Kompetensi 2"
                  width="25%"
                />
              </div>
              <div class="card-body">
                <h5 class="card-title text-center">PPLG</h5>
                <p class="card-text">Pengembangan perangkat lunak dan game</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card shadow-sm text-center" style="width: 100%">
              <div class="icon-container mx-auto mt-3">
                <img
                  src="/assets/tjkt.jpg.jpg"
                  class="card-icon"
                  alt="Icon Kompetensi 3"
                  width="25%"
                />
              </div>
              <div class="card-body">
                <h5 class="card-title text-center">TJKT</h5>
                <p class="card-text">Teknik komputer & jaringan komputer</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card shadow-sm text-center" style="width: 100%">
              ...
              <div class="card-body">
                ...
                <p class="card-text">Teknik otomasi industri</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card shadow-sm text-center" style="width: 100%">
              ...
              <div class="card-body">
                ...
                <p class="card-text">Teknik bisnis sepedah motor</p>
              </div>
            </div>
          </div>
